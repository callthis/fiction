...
[^3]: Here is one of the better explanations about how "tit-for-tat policies" have come to be rationalized as being "the best strategy", due to the ideas being pushed by Western consulting companies and universities. The elucidating video is from a world renowned, and trustworthy Canadian author of research based multimedia content, whose name and face, is likely to be on the front page cover, of a future edition of Maclean's magazine - 
    ...
    The linchpin in all of the research about Prisoners' Dilemma conducted by numerous research teams working on Game Theoretic Models, throughout the world for the past three decades, is the *assumption* that non-idiomatic discrete options with significantly different, unambiguously discernible, and guaranteed values of pay outs exist, for mutually exclusive *expected* outcomes, in a dilemma. But, that assumption usually doesn't hold true in real life situations involving actual hostages or prisoners. 

    Do you suppose passengers of [United Airlines Flight 93](https://en.wikipedia.org/wiki/United_Airlines_Flight_93), on September-11-2001, would have been better off by cooperating with their hijackers, instead of fighting back? Similarly, can all people on Earth genuinely continue to be healthier and happier, by cooperating with fossil fuel companies that have hijacked the planet? The strategy of non-alignment and non-cooperation for attaining freedom from murderous oppressors and violators, has a worth, that isn't measurable in terms of money, nor is it translatable into simplistic numerical models. 

    Multi-lemmas can be incredibly difficult to parse, let alone, resolve equitably for all parties involved.  